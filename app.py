...
yf.pdr_override()  # Override yfinance with pandas_datareader backend
...
if predict_button:
    ...
    try:
        ...
        df = pdr.get_data_yahoo(ticker, start='2018-01-01', end=today)
        ...
        if df.empty:
            ...
            # Twitter sentiment (from nitter.net)
            tweets = []
            try:
